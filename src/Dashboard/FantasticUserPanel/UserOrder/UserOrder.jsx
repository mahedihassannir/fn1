...
const UserOrder = () => {
    ...
    const myOrders = orders.filter(x => x.email === 'aanika.chowdhury04@gmail.com')
    ...
    return (
        <div className=" mx-auto">
            ...
            <div className="my-10 ">
                ...
                <div className="grid gap-5 overflow-y-auto max-h-96">
                    {
                        myOrders.map((x,index) =>
                            <div key={index} className=" text-gray-700 bg-white text-sm font-semibold p-5 shadow grid grid-cols-2" >
                                <div>
                                    <p className="">Order Number #30030</p>
                                    <h1>Total Price: {x.product.Total_Payment} {x.product.currency}</h1>
                                    <p>Payment method: Cash On Delivery</p>
                                    <p>Payment Status:
                                        <span className={x?.paidStatus === true ? 'text-green-700' : 'hidden'}> Paid</span>
                                        <span className={x?.paidStatus === false ? 'text-red-700':'hidden'}> Due</span>
                                    </p>
