...
const Nav = ({ isNavOpen, setIsNavOpen }) => {
	...
	const handleInputChange = async (input) => {
		...
		try {
			const response = await axios.get(`https://e-com-server-7zwq.onrender.com/suggestions?search=${input}`);
	...
	const handleSearch = async (e) => {
		...
		try {
			...
			const response = await axios.get(`https://e-com-server-7zwq.onrender.com/api/v1/user/search?query=${searchTerm}`, {
