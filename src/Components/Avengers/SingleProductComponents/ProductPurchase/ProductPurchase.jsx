...
const ProductPurchase = ({ singleProductData }) => {
	...
	const handleAddtoCart = (data) => {
		...
		fetch(`https://e-com-server-7zwq.onrender.com/api/v1/user/add_cart?userId=${userProfile?.sanitizedResult?._id}`, {
			method: "POST",
			headers: {
	...
	const handleWishList = (data) => {
		...
		fetch("https://e-com-server-7zwq.onrender.com/api/v1/user/wish_list", {
			method: "POST",
			headers: {
				'Content-Type': 'application/json',
				Authorization: `Bearer ${authToken}`
